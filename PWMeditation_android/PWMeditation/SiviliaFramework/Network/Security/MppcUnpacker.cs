...
namespace SiviliaFramework.Network.Security
{
    class MppcUnpacker
    {
        ...
        private int code2 { get; set; }
        private int code3 { get; set; }
        private int code4 { get; set; }

        private byte packedOffset { get; set; }

        private List<byte> packedBytes { get; set; }
        private List<byte> unpackedBytes { get; set; }
        private List<byte> unpackedChunk { get; set; }
